...
`redis` can be configured when adding a `redisUrl` property in the `credentials.json` file.
See `https://github.com/luin/ioredis#connect-to-redis` for configuration details.
