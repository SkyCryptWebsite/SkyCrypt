...
function formatStat(stat, ability_damage = false) {
    ...
    if (statFloored > 0 && !ability_damage) return `§a+${statFloored}`;
...
class Pet {
    ...
    lore(newStats = false) {
        if (!newStats) newStats = this.stats;
        let list = [];
        for (const stat in newStats) {
            switch (stat) {
                ...
                case "bonus_attack_speed":
                    list.push(
                        `§7Bonus Attack Speed: ${formatStat(newStats[stat])}`
                    );
                    break;
                case "sea_creature_chance":
                    list.push(
                        `§7Sea Creature Chance: ${formatStat(newStats[stat])}`
                    );
                    break;
                case "magic_find":
                ...
                case "ability_damage":
                    list.push(
                        `§7Ability Damage: ${formatStat(newStats[stat], true)}`
                    );
                    break;
                case "damage":
...
class Bee extends Pet {
    ...
    get abilities() {
        let list = [this.first];
        if (this.rarity > 1) list.push(this.second);
        if (this.rarity > 3) list.push(this.third);
        return list;
    }
        ...
        return {
            ...
            desc: [
                `§7Gain §a${round(
                    5 + this.level * mult,
                    1
                )}% §7of recieved damage as §6${symbols.health} Absorption`,
            ],
        };
    }
}
...
class Chicken extends Pet {
    ...
    get first() {
        ...
        return {
            name: "§6Light Feet",
            desc: [
                `§7Reduces fall damage by §a${round(this.level * mult, 1)}%`,
            ],
        };
    }
        ...
        return {
            ...
            desc: [
                `§7Gain §a${round(this.level * mult, 1)} ${
                    symbols.defense
                } Defense §7for every §f100 ${symbols.speed} Speed`,
            ],
        };
    }
        ...
        return {
            ...
            desc: [
                `§7Gain §c${round(this.level * mult, 1)} ${
                    symbols.health
                } Health §7for every §a10 ${symbols.defense} Defense`,
            ],
        };
    }
        ...
        return {
            ...
            desc: [
                `§7Grants a §a${round(
                    this.level * mult,
                    1
                )}% §7chance to get double crops while farming`,
            ],
        };
    }
}
...
class Pig extends Pet {
    ...
    get abilities() {
        ...
        if (this.rarity > 1) list.push(this.third);
        if (this.rarity > 3) list.push(this.fourth);
        return list;
    }
...
class Rabbit extends Pet {
    ...
    get first() {
        ...
        return {
            name: "§6Happy Feet ",
            desc: [
                `§7Jump Potions also give §a+${round(
                    this.level * mult,
                    0
                )} §7speed`,
            ],
    ...
    get second() {
        ...
        return {
            ...
            desc: [
                `§7Boosts your Farming Exp by §a${round(
                    this.level * mult,
                    1
                )}%`,
            ],
...
class Bat extends Pet {
    ...
    get abilities() {
        ...
        if (this.rarity > 1) list.push(this.second);
        if (this.rarity > 3) list.push(this.third);
        if (this.rarity > 4) list.push(this.fourth);
        return list;
    }
    ...
    get second() {
        ...
        return {
            name: "§6Nightmare",
            desc: [
                `§7During night, gain §a${round(
                    this.level * mult_intel,
                    1
                )} §9${symbols.intelligence} Intelligence, §a${round(
...
class Endermite extends Pet {
    ...
    get second() {
        ...
        return {
            name: "§6Pearl Muncher",
            desc: [
                `§7Upon picking up an ender pearl, consume it and gain §a${
    ...
    get third() {
        ...
        return {
            name: "§6Pearl Powered",
            desc: [
                `§7Upon consuming an ender pearl, gain +§a${
                    10 + round(this.level * mult, 1)
                } §7speed for 10 seconds`,
            ],
        };
    }
}
...
class Silverfish extends Pet {
    ...
    get second() {
        ...
        return {
            ...
            desc: [
                `§7Boosts your Mining exp by §a${round(this.level * mult, 1)}%`,
            ],
        };
    }
...
class EnderDragon extends Pet {
        ...
        return {
            ...
            desc: [
                `§7Buffs the Aspect of the Dragons sword by §a${round(
                    this.level * 0.5,
                    1
                )} §c${symbols.strength} Damage and §a${round(
                    this.level * 0.3,
                    1
    ...
    get third() {
        ...
        return {
            name: "§6Superior",
            desc: [
                `§7Increases all stats by §a${round(this.level * mult, 1)}%`,
            ],
        };
    }
...
class Ghoul extends Pet {
    ...
    get first() {
        ...
        return {
            ...
            desc: [
                `§7Increase all healing by §a${round(this.level * mult, 1)}%`,
            ],
        };
    }
...
class Golem extends Pet {
    ...
    get first() {
        ...
        return {
            name: "§6Last Stand",
            desc: [
                `§7While less than 15% HP, deal §a${round(
                    this.level * mult,
                    1
                )}% §7more damage`,
            ],
        ...
        return {
            ...
            desc: [
                `§7Your iron plating causes §a${round(
                    this.level * mult,
                    1
                )}% §7of attacks to rocochet and hit the attacker`,
            ],
        };
    }
...
class Griffin extends Pet {
    ...
    get abilities() {
        let list = [this.first];
        if (this.rarity > 0) list.push(this.second);
        if (this.rarity > 2) list.push(this.third);
        if (this.rarity > 3) list.push(this.fourth);
        return list;
    }
    ...
    get second() {
        ...
        return {
            ...
            desc: [
                `§7Permanent §cRegeneration ${regen} §7and §4Strength ${stren}§7.`,
            ],
        };
    }
        ...
        return {
            ...
            desc: [
                `§7Gain §c+${round(
                    1 + this.level * 0.14,
                    1
                )}% §c❁ Strength §7when above §c85% §7health.`,
            ],
        };
    }
}
...
class Guardian extends Pet {
    ...
    get first() {
        ...
        return {
            name: "§6Lazerbeam",
            desc: [
                `§7Zap your enemies for §b${round(
                    this.level * mult,
                    1
                )}x §7your §b${symbols.intelligence} Intelligence §7every §a3s`,
            ],
        };
    }
    ...
    get second() {
        ...
        return {
            ...
            desc: [
                `§7Boosts your Enchanting exp by §a${round(
                    this.level * mult,
                    1
                )}%`,
            ],
...
class MagmaCube extends Pet {
    ...
    get third() {
        ...
        return {
            name: "§6Hot Ember",
            desc: [
                `§7Buffs the stats of Ember Armor by ${round(
                    this.level * mult,
                    1
                )}%`,
            ],
    ...
    get first() {
        ...
        return {
            ...
            desc: [
                ...
                } ${symbols.strength} Strength §7for ${
        ...
        return {
            ...
            desc: [
                `§7Buffs the Pigman sword by §a${round(
                    ...
                    1
                )} §c${symbols.strength} Damage and §7§a${round(
...
class Skeleton extends Pet {
    ...
    get third() {
        ...
        return {
            ...
            desc: [
                `§7Your skeleton shoots an arrow dealing §a60x §7your §9${symbols.crit_damage} Crit Damage §7when a mob gets close to you (15s cooldown)`,
            ],
        };
    }
}
...
class Spirit extends Pet {
    ...
    get second() {
        ...
        return {
            name: "§6Spirit Leap",
            desc: [
                `§7Grants a §a10% §7chance for mini-bosses in dungeons to drop §b5 §7Spirit Leap Pearls.`,
            ],
        };
    }
...
class Tarantula extends Pet {
    ...
    get second() {
        ...
        return {
            name: "§6Eight Legs",
            desc: [
                `§7Decreases the mana cost of Spider and Tarantula boots by §a${round(
                    this.level * mult,
                    1
                )}%`,
            ],
...
class Tiger extends Pet {
    ...
    get second() {
        ...
        return {
            name: "§6Hemorrhage",
            desc: [
                `§7Melee attacks reduce healing by §a${round(
                    this.level * mult,
                    1
                )}% §7for 10 seconds`,
            ],
...
class Turtle extends Pet {
    ...
    get second() {
        ...
        return {
            ...
            desc: [
                `§7Gain §a+${round(this.level * mult_defense, 1)} ${
                    symbols.defense
                } Defense §7and regen §c+${round(this.level * mult_health, 1)}${
                    symbols.health
                } §7per second when near or in water`,
            ],
        };
    }
...
class Wolf extends Pet {
    ...
    get third() {
        ...
        return {
            ...
            desc: [
                `§7Boosts your Combat exp by §a${round(this.level * mult, 1)}%`,
            ],
        };
    }
}
...
class Zombie extends Pet {
    ...
    get first() {
        ...
        return {
            name: "§6Chomp",
            desc: [
                `§7Gain +§a${round(this.level * mult, 1)} §7hp per zombie kill`,
            ],
        };
    }
...
class Giraffe extends Pet {
    ...
    get second() {
        ...
        return {
            name: "§6Higher Ground",
            desc: [
                `Grants §c+${round(this.level * strMult, 1)} ${
                    symbols.strength
                } Strength §7and §9+${round(this.level * cdMult + 20, 1)} ${
                    symbols.crit_damage
...
class Lion extends Pet {
    ...
    get second() {
        ...
        return {
            name: "§6First Pounce",
            desc: [
                `Increases damage dealt by §a${round(
                    this.level * mult,
                    1
                )}% §7on your first hit on a mob`,
            ],
        };
    }
        ...
        return {
            ...
            desc: [
                `Deal §c+${round(
                    this.level * mult,
                    1
                )}% ❁ Damage §7against mobs below level §a80`,
            ],
        };
    }
}
...
class Monkey extends Pet {
    ...
    get first() {
        ...
        return {
            name: "§6Treeborn",
            desc: [
                `§7Increase double drop rates for logs by §a${round(
                    this.level * mult,
                    1
                )}%`,
            ],
...
class Ocelot extends Pet {
    ...
    get first() {
        ...
        return {
            ...
            desc: [
                `§7Boosts your Foraging exp by §a${round(
                    this.level * mult,
                    1
                )}%`,
            ],
...
class BabyYeti extends Pet {
        ...
        return {
            ...
            desc: [
                `§7Gain §a${round(
                    this.level * mult,
                    1
                )}% §7of your strength as §a${symbols.defense} Defense`,
            ],
        };
    }
        ...
        return {
            ...
            desc: [
                `§7Buff the Yeti sword by §a${round(this.level * mult, 1)} §c${
                    symbols.strength
                } Damage §7and §9${symbols.intelligence} Intelligence`,
            ],
        };
    }
    ...
    modifyStats(stats) {
        if (this.rarity > 2) {
            let mult = 1;
            stats["defense"] +=
                (round(this.level * mult, 1) / 100) * stats["strength"];
        }
    }
}
...
class BlueWhale extends Pet {
    ...
    get second() {
        let mult = 0.03;
        let health =
            this.rarity > 3 ? "20.0" : this.rarity > 2 ? "25.0" : "30.0";
        return {
            name: "§6Bulk",
            desc: [
                `§7Gain §a${round(this.level * mult, 1)} ${
                    symbols.defense
                } Defense §7per §c${health} Max ${symbols.health} Health`,
            ],
        };
    }
...
class Dolphin extends Pet {
    ...
    get second() {
        ...
        return {
            name: "§6Echolocation",
            desc: [
                `§7Increases sea creatures catch chance by §a${round(
                    this.level * mult,
                    1
                )}%`,
            ],
...
class FlyingFish extends Pet {
    ...
    get first() {
        ...
        return {
            name: "§6Quick Reel",
            desc: [
                `§7Increases fishing speed by §a${round(
                    this.level * mult,
                    1
                )}%`,
            ],
    ...
    get third() {
        ...
        return {
            ...
            desc: [
                `§7Increases the stats of Diver Armor by §a${round(
                    this.level * mult,
                    1
                )}%`,
            ],
        ...
        return {
            ...
            desc: [
                `§7On kill gain §c${round(mult * this.level, 1)}${
                    symbols.strength
                } Damage §7and §f${symbols.speed} Speed §7for 5 seconds`,
            ],
        };
    }
}
...
class Squid extends Pet {
    ...
    get second() {
        ...
        return {
            name: "§6Ink Specialty",
            desc: [
                `§7Buffs the Ink Wand by §a${round(
                    this.level * mult_damage,
                    1
                )} §c${symbols.strength} Damage §7and §a${round(
                    this.level * mult_strength,
                    1
                )} §c${symbols.strength} Strength`,
            ],
    ...
    get third() {
        ...
        return {
            ...
            desc: [
                `§7Boosts your Fishing exp by §a${round(
                    this.level * mult,
                    1
                )}%`,
            ],
...
class Parrot extends Pet {
    ...
    get second() {
        ...
        return {
            name: "§6Repeat",
            desc: [
                `§7Boosts potion duration by §a${round(
                    5 + this.level * mult,
                    1
                )}%`,
            ],
    ...
    get third() {
        ...
        return {
            ...
            desc: [
                `§7Gives §c+${symbols.strength}${round(
                    5 + this.level * mult,
                    1
...
class Sheep extends Pet {
    ...
    get first() {
        ...
        return {
            name: "§6Mana Saver",
            desc: [
                `§7Reduces the mana cost of abilites by §a${round(
                    this.level * mult,
                    1
                )}%`,
            ],
...
class Jerry extends Pet {
        ...
        return {
            ...
            desc: [
                `§7Gain §a${round(
                    mult,
                    1
                )}% §7chance to deal your regular damage.`,
            ],
        };
    }
        ...
        return {
            ...
            desc: [
                `§7Gain §a${round(
                    mult,
                    1
                )}% §7chance to receive a normal amount of drops from mobs.`,
            ],
        };
    }
    ...
    get third() {
        ...
        return {
            name: "§6Jerry",
            desc: [
                `§7Actually adds ${Math.floor(
                    this.level * mult
                )} damage to the Aspect of the Jerry.`,
            ],
        };
    }
}
