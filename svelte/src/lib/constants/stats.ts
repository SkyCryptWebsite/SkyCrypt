...
export const HIDDEN_STATS = ["alchemy_wisdom", "carpentry_wisdom", "combat_wisdom", "enchanting_wisdom", "farming_wisdom", "fishing_wisdom", "foraging_wisdom", "mining_wisdom", "runecrafting_wisdom", "social_wisdom"];
